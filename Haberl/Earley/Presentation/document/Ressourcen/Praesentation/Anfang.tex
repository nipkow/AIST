...
\newcommand{\PraesentationTitelseiteInhalt}{
    \begin{textblock*}{\paperwidth}[0,0](0cm,-\PraesentationSeitenrand - 6.5mm + \PraesentationPositionKorrekturOben)%
        \color{PraesentationTextfarbe}%
        %\PraesentationUeberschriftZweizeilig{Implementation of Verlet Lists for 3-Body}{Interactions in AutoPas}
        \frametitle{Formal Verification of Earley's Parsing Algorithm, Including Running Time Analysis}
        \vspace*{64.4mm}
...
\newcommand{\PraesentationTitelseite}{\frame[plain, noframenumbering]{\titlepage}}
...
\setbeamertemplate{footline}{
    \hbox{%
        ...
        %    \PersonTitel{} \PersonVorname~\PersonNachname~\PraesentationFusszeileZusatz{}%
        \end{beamercolorbox}%
