...
%
\begin{isamarkuptext}%
If the valuation \isa{v} maps all variables occurring in the regular language expression \isa{f} to
...
\isatagdocument
%
\isamarkupsubsection{Constant regular language expressions%
}
\isamarkuptrue%
%
\endisatagdocument
