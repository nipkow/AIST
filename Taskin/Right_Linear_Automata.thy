...
shows "nfa.language (nfa_rlin2 P S) = CFG.Lang P S"
proof -
...
lemma dfa_language_eq_Lang: "dfa.language M = Lang Prods_dfa (dfa.init M)"
unfolding language_def Lang_def by (simp add: Prods_dfa_iff_dfa)

end

lemma rlin2_if_regular: assumes "regular L"
  shows "\<exists>P S::hf. rlin2 P \<and> L = CFG.Lang P S"
by (metis assms dfa.dfa_language_eq_Lang dfa.rlin2_prods_dfa regular_def)
